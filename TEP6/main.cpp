...
void v_tree_test3() {
  ...
  c_tree2.pcGetRoot()->pcGetChild(0)->vAddNewChild();
  c_tree2.pcGetRoot()->pcGetChild(0)->vAddNewChild();
  c_tree2.pcGetRoot()->pcGetChild(0)->pcGetChild(0)->vSetValue("5");
  c_tree2.pcGetRoot()->pcGetChild(0)->pcGetChild(1)->vSetValue("6");
  c_tree2.pcGetRoot()->pcGetChild(1)->vAddNewChild();
  c_tree2.pcGetRoot()->pcGetChild(1)->vAddNewChild();
  c_tree2.pcGetRoot()->pcGetChild(1)->pcGetChild(0)->vSetValue("41");
  c_tree2.pcGetRoot()->pcGetChild(1)->pcGetChild(1)->vSetValue("41");
